...
pattern and AEtest structure. Call `damira_search_vendor_docs` when you need a parser or
...
```bash
python3 "<plugin root>/scripts/damira.py" validate tests/ --skill generate-tests --host claude-code
```
